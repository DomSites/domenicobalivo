...
<?php if ( $sidebars && ut_page_option( 'ut_footerarea', 'on' ) == 'on' && ut_search_result_status() ) : ?>
    ...
    <footer class="footer ut-footer-has-widgets <?php echo ut_page_option('ut_footer_skin' , 'ut-footer-light'); ?> ut-footer-fullwidth-<?php echo ut_page_option( 'ut_footerarea_width', 'off' ); ?>">      
