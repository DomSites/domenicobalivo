<?php if( ut_page_option( 'ut_top_header', 'hide' ) == 'hide' ) { return; } ?>

<!-- Start UT-Top-Header -->
<div id="ut-top-header" class="hide-on-tablet hide-on-mobile ut-top-header-<?php echo ot_get_option( 'ut_top_header_font_size', 'small' ); ?> ut-top-header-<?php echo ot_get_option( 'ut_top_header_width', 'fullwidth' ); ?> clearfix">
